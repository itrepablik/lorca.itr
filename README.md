...
![counter](https://user-images.githubusercontent.com/58651329/76183819-ba1bd980-6204-11ea-9d01-5f01a0d5e515.gif)
...
## ITRepablik versions of Lorca package.

* Maximize the full screen at runtime.
* Avoid **go generate** process each time you build your application for your static assets like **CSS**, **JS**, **images**, etc., instead, create a new folder name **html** outside of your **www** assets directory in which **Lorca** reads by default.  This will avoid slowness during the development period as all of the static assets inside the **html** folder will be treated as local file access only that you can modify in real-time without the need to use the **go generate** command before bundling it to **assets.go**.
* When your application is ready for deployment, include the folder name **html** from **gen.go** e.g
...
func main() {
	...
	lorca.Embed("main", "assets.go", "www", "html")
}
```
